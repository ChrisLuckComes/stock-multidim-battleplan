...
- **强共振后不接一致预期（连涨走满只观察不买）**：同板块多票（≥5 只）近期同步上涨、β 共振强，只作信号加分项，不代表此刻能追；连涨 ≥3 天且涨幅走满（距 MA20 溢出 >10% / 距目标墙 <3%）的票，追高即接一致预期、盈亏比塌，只加自选观察不买，等温和调整（回踩不破结构位 + 缩量企稳）转买点。与「不追高」同源（2026-09-20 订）。
