...
- **赔率优先 / 买点前移（环境适配）**：标准突破（新高/杯柄/高位平台等）在流畅单边仍好用；突破后高波动、止损被迫放宽时赔率变差（A 股 T+1 更甚）→ 优先「强势股关键支撑低吸」或「紧凑盘整第一次启动」，映射到沿线回踩 / 大阳后缩量 / 旗形启动等现有模式，不另造第七种买法。计划须能答：在哪里知错、错了亏多少、对了赚多少。
